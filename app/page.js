...
const CardHpi = () => {
  return (
    <div className='about-page'>
      <div>
    <div className="card-hpi">
      <div className="card-inner-hpi">
        <div className="card-front-hpi">
          <div className="card-bg-hpi"></div>
          <div className="card-glow-hpi"></div>
          <svg
            width="72"
            height="24"
            viewBox="0 0 72 24"
          ...
          <div className="card-contactless-hpi">
          ...
          <div className="card-chip-hpi"></div>
          <div className="card-holder-hpi">Aravind Ganesh</div>
          <div className="card-number-hpi">
          </div>          
          <div className="card-valid-hpi">infinity</div>
        </div>
        <div className="card-back-hpi">
          <div className="card-signature-hpi">Aravind Ganesh</div>
          <div className="card-seccode-hpi">123</div>
        </div>
      </div>
    </div>
    <div className="hint-hpi">Hover me ;)</div>
    </div>
    </div>
  );
};

export default CardHpi;
